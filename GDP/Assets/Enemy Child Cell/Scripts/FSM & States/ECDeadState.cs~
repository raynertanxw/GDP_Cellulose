...
public class ECDeadState : IECState {
	...
	//a vector to store the position for respawning the dead enemy child cell
	...
	//A function to disable the enemy child cells by disabling the visual and collisions of the child cell and
